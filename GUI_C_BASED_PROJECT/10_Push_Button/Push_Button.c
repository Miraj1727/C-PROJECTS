...
{
    static TCHAR szAppName[] = TEXT("MIRAJ MAHAJAN");
    HWND hwnd;
    MSG msg;
    WNDCLASS wndclass;
    ...
    hwnd = CreateWindow(szAppName, TEXT("MIRAJ MAHAJAN"),
                        WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        // Draw "MIRAJ MAHAJAN" centered within the frame
        DrawText(hdc, TEXT("MIRAJ MAHAJAN"), -1, &frameRect, DT_SINGLELINE | DT_CENTER | DT_VCENTER);
